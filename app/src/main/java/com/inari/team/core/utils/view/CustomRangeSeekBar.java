...
public class CustomRangeSeekBar extends View {
    ...
    private CustomRangeSeekBar.Thumb pressedThumb;
    ...
    public CustomRangeSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomRangeSeekBar);
        try {
    ...
    public CustomRangeSeekBar setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }

    public CustomRangeSeekBar setMinValue(float minValue) {
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public CustomRangeSeekBar setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public CustomRangeSeekBar setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        this.absoluteMinStartValue = minStartValue;
        return this;
    }

    public CustomRangeSeekBar setMaxStartValue(float maxStartValue) {
        this.maxStartValue = maxStartValue;
        this.absoluteMaxStartValue = maxStartValue;
        return this;
    }

    public CustomRangeSeekBar setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public CustomRangeSeekBar setGap(float gap) {
        this.gap = gap;
        return this;
    }

    public CustomRangeSeekBar setFixGap(float fixGap) {
        this.fixGap = fixGap;
        return this;
    }

    public CustomRangeSeekBar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public CustomRangeSeekBar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public CustomRangeSeekBar setLeftThumbColor(int leftThumbColorNormal) {
        this.leftThumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public CustomRangeSeekBar setLeftThumbHighlightColor(int leftThumbColorPressed) {
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public CustomRangeSeekBar setLeftThumbDrawable(int resId) {
    ...
    public CustomRangeSeekBar setLeftThumbHighlightDrawable(int resId) {
    ...
    public CustomRangeSeekBar setRightThumbColor(int rightThumbColorNormal) {
        this.rightThumbColorNormal = rightThumbColorNormal;
        return this;
    }

    public CustomRangeSeekBar setRightThumbHighlightColor(int rightThumbColorPressed) {
        this.rightThumbColorPressed = rightThumbColorPressed;
        return this;
    }

    public CustomRangeSeekBar setRightThumbDrawable(int resId) {
    ...
    public CustomRangeSeekBar setRightThumbHighlightDrawable(int resId) {
    ...
    public CustomRangeSeekBar setDataType(int dataType) {
    ...
    protected CustomRangeSeekBar.Thumb getPressedThumb() {
        return pressedThumb;
    }
    ...
    protected float getCornerRadius(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.CustomRangeSeekBar_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_bar_color, Color.GRAY);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_bar_highlight_color, Color.BLACK);
    }

    protected int getLeftThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_left_thumb_color, Color.BLACK);
    }

    protected int getRightThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_right_thumb_color, Color.BLACK);
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_left_thumb_color_pressed, Color.DKGRAY);
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CustomRangeSeekBar_right_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getLeftDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.CustomRangeSeekBar_left_thumb_image);
    }

    protected Drawable getRightDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.CustomRangeSeekBar_right_thumb_image);
    }

    protected Drawable getLeftDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.CustomRangeSeekBar_left_thumb_image_pressed);
    }

    protected Drawable getRightDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.CustomRangeSeekBar_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.CustomRangeSeekBar_data_type, CustomRangeSeekBar.DataType.INTEGER);
    }
    ...
    protected void setupLeftThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        leftThumbColor = (CustomRangeSeekBar.Thumb.MIN.equals(pressedThumb)) ? leftThumbColorPressed : leftThumbColorNormal;
        ...
        if (leftThumb != null) {
            Bitmap lThumb = (CustomRangeSeekBar.Thumb.MIN.equals(pressedThumb)) ? leftThumbPressed : leftThumb;
    ...
    protected void setupRightThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        rightThumbColor = (CustomRangeSeekBar.Thumb.MAX.equals(pressedThumb)) ? rightThumbColorPressed : rightThumbColorNormal;
        ...
        if (rightThumb != null) {
            Bitmap rThumb = (CustomRangeSeekBar.Thumb.MAX.equals(pressedThumb)) ? rightThumbPressed : rightThumb;
    ...
    protected void trackTouchEvent(MotionEvent event) {
        ...
        try {
            ...
            if (CustomRangeSeekBar.Thumb.MIN.equals(pressedThumb)) {
                setNormalizedMinValue(screenToNormalized(x));
            } else if (CustomRangeSeekBar.Thumb.MAX.equals(pressedThumb)) {
...
//    }
    ...
    private CustomRangeSeekBar.Thumb evalPressedThumb(float touchX) {
        ...
        if (minThumbPressed && maxThumbPressed) {
            ...
            result = (touchX / getWidth() > 0.5f) ? CustomRangeSeekBar.Thumb.MIN : CustomRangeSeekBar.Thumb.MAX;
    ...
    private <T extends Number> Number formatValue(T value) throws IllegalArgumentException {
        ...
        if (dataType == CustomRangeSeekBar.DataType.LONG) {
            return v.longValue();
        }
        if (dataType == CustomRangeSeekBar.DataType.DOUBLE) {
            return v;
        }
        if (dataType == CustomRangeSeekBar.DataType.INTEGER) {
            return Math.round(v);
        }
        if (dataType == CustomRangeSeekBar.DataType.FLOAT) {
            return v.floatValue();
        }
        if (dataType == CustomRangeSeekBar.DataType.SHORT) {
            return v.shortValue();
        }
        if (dataType == CustomRangeSeekBar.DataType.BYTE) {
            return v.byteValue();
        }
