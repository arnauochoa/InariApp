 ...
 */
public class CustomAHBottomNavigation extends FrameLayout {
    ...
    private ArrayList<CustomAHBottomNavigationItem> items = new ArrayList<>();
    private ArrayList<View> views = new ArrayList<>();
    private AHBottomNavigationBehavior<CustomAHBottomNavigation> bottomNavigationBehavior;
    ...
    private com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState titleState = com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.SHOW_WHEN_ACTIVE;
     ...
     * Constructors
     */
    public CustomAHBottomNavigation(Context context) {
        super(context);
        init(context, null);
    }

    public CustomAHBottomNavigation(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomAHBottomNavigation(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void createItems() {
        ...
        if (titleState != com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_HIDE &&
                (items.size() == MIN_ITEMS || titleState == com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_SHOW)) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                requestLayout();
                View initialView = getViewAtPosition(0);
                if (initialView != null){
                    setItemSelected(0);
//                    initialView.setBackgroundColor(selectedBackgroundColor);
                }
            }
        });
    }
    ...
    private boolean isClassic() {
        return titleState == com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_SHOW || items.size() <= MIN_ITEMS && titleState != com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_SHOW;
    }
    ...
    private void createClassicItems(LinearLayout linearLayout) {
        ...
        if (titleState == com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_SHOW && items.size() > MIN_ITEMS) {
        ...
        } else if (titleState == com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState.ALWAYS_SHOW && items.size() > MIN_ITEMS) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            CustomAHBottomNavigationItem item = items.get(itemIndex);
     ...
     * Add an item
     */
    public void addItem(CustomAHBottomNavigationItem item) {
     ...
     * Add all items
     */
    public void addItems(List<CustomAHBottomNavigationItem> items) {
     ...
     */
    public CustomAHBottomNavigationItem getItem(int position) {
     ...
     * @return TitleState
     */
    public com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState getTitleState() {
        return titleState;
    }
     ...
     */
    public void setTitleState(com.aurelhubert.ahbottomnavigation.AHBottomNavigation.TitleState titleState) {
