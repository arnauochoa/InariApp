 ...
 * This class is used in conjunction with the {@link android.location.GnssStatus.Callback}.
 */
public final class GnssStatus {
    ...
    final int[] mConstellationTypes;

    public GnssStatus(int svCount, int[] svidWithFlags, float[] cn0s, float[] elevations,
                      float[] azimuths, float[] carrierFrequencies, int[] constellationTypes) {
        mSvCount = svCount;
    ...
    public int getSvid(int satIndex) {
        return mSvidWithFlags[satIndex];
    }
