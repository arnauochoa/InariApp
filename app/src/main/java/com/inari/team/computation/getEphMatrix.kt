...
//import com.inari.team.computation.data.Ephemeris
...
//
//fun getEphMatrix(acqInformation: AcqInformation, mode: Mode): HashMap<String, List<Ephemeris>> {
//
...
////        when (it) {
////            GPS -> {
////                val ephList = arrayListOf<Ephemeris>()
////
////                acqInformation
////
////
